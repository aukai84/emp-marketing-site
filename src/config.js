export default {
  currencyList: [
    ...
    { value: 'USD', label: 'United States (US $)' },
  ...
  filters: [
...

    {
      category: 'size',
      items: [
        { name: 'XXS', value: false },
        { name: 'XS', value: false },
        { name: 'S', value: false },
        { name: 'M', value: false },
        { name: 'L', value: false },
        { name: 'XL', value: false },
        { name: 'XXL', value: false },
        { name: 'Onesize', value: false },
      ],
    },
    {
      category: 'gender',
